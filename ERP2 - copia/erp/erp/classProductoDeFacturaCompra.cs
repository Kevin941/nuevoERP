...
namespace erp
{
    public class classProductoDeFacturaCompra
    {
        ...
        public classProductoDeFacturaCompra()
        {
            server = "localhost";
            database = "db_erp";
            uid = "root";
        ...
        public void Insert()
        {
            string query = "INSERT INTO db_erp.t_detalleCompra (idCompra, idProducto, total, cantidad) " +
                "VALUES(" +
                "'" + idCompra + "'" + ", " +
                "'" + idProducto + "'" + ", " +
                "'" + total + "'" + ", " +
        ...
        public void Delete()
        {
            string query = "DELETE FROM db_erp.t_detalleventa WHERE idCompra='" + idCompra + "' and idProducto='" + idProducto + "';";
